...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9227a0c3-bebe-4e0b-a4e4-0741c8bc27ce' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('edababfb-9e44-4632-9c8d-fe2446a630a7');
      cy.get(`[data-cy="name"]`).should('have.value', 'edababfb-9e44-4632-9c8d-fe2446a630a7');
