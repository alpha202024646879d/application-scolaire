package com.doudhal.connect.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.doudhal.connect.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.doudhal.connect.security.DomainUserDetailsService", "createSpringSecurityUser");
